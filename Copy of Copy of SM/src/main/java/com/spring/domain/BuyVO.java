...
// 주문상태  0입금대기 1결제확인중 2결제완료 3배송준비 4배송중 5배송완료
	...
	public BuyVO(int buy_no, String b_id, int p_no, String p_name, int p_price, int buy_cnt, String o_cont,
			Date buy_date, String delivery_zip, String delivery_addr, int buy_status) {
		this.buy_no = buy_no;
		this.b_id = b_id;
		this.p_no = p_no;
		this.p_name = p_name;
